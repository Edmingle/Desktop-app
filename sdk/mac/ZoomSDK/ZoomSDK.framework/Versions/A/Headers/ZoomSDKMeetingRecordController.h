...
/**
 * @brief Object to handle a user's request to start cloud recording. If the current user can control web setting for smart recording, they will get IMeetingSmartRecordingReminderHandler when an attendee requests to start cloud recording or start cloud recording by self.
 */
