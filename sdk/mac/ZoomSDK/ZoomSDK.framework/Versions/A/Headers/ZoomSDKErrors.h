...
typedef enum
{
    ...
    ZoomSDKReminderType_SmartSummaryEnableRequestReminder,// reminder type of smart summary enable request.
    ZoomSDKReminderType_QueryDisclaimer,// reminder type of query disclaimer.
    ZoomSDKReminderType_QueryEnableRequestReminder,// reminder type of query enable request.
    ZoomSDKReminderType_EnableSmartSummaryReminder,//reminder type of enable smart summary.
    ...
    ZoomSDKReminderType_SmartRecordingEnableRequestReminder,//Reminder type to enable smart recording request.
    ZoomSDKReminderType_EnableSmartRecordingReminder,//Reminder type to enable smart recording.
    ZoomSDKReminderType_AICompanionPlusDisclaimer,// reminder type of AICompanionPlus disclaimer.
...
typedef enum
{
    ...
    //The request cloud recording timeds out.
