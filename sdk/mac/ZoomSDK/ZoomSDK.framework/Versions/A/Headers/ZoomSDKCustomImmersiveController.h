 ...
 */
@property(nonatomic,retain, readonly) ZoomSDKCustomImmersiveTemplateData* shareTemplateData;

/**
 * @brief The template data of immersive when in default mode.
 */
@property(nonatomic,retain, readonly) ZoomSDKCustomImmersiveTemplateData* videoTemplateData;
@end
 ...
 * @return If the function succeeds, it will return ZoomSDKError_Success. Otherwise failed. To get extended error information, see {@link ZoomSDKError}.
 */
- (ZoomSDKError)getViewingShareUser:(unsigned int*)userID;
