...
#import "ZoomSDKMeetingSmartSummaryController.h"
/**
...
@property (retain, nonatomic) NSString *zoomDomain DEPRECATED_MSG_ATTRIBUTE("No longer used");
//@property (assign, nonatomic) BOOL needCustomizedUI;
 ...
 */
- (void)setZoomDomain:(NSString*)domain DEPRECATED_MSG_ATTRIBUTE("No longer used");
/**
...
/**
 * @brief Get object of controller ZoomSDKMeetingSmartSummaryController.
 * @return If the function succeeds, it will return a ZoomSDKMeetingSmartSummaryController object.
 */
 ...
 */
- (ZoomSDKError)setSupportDarkModel:(BOOL)isSupport DEPRECATED_MSG_ATTRIBUTE("No longer used");
