 ...
 * @param shareType Share type change. For detail, see {@link ZoomSDKFocusModeShareType}.
 */
 ...
 * @param shareType The type of focus mode share type. For detail, see {@link ZoomSDKFocusModeShareType}.
 * @return If the function succeeds, it will return ZoomSDKError_Success, otherwise not.
 */
