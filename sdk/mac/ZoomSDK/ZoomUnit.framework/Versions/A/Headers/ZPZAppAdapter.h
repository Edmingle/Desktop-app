...
typedef NS_ENUM(NSInteger, ZMAppType) {
    ...
    ZMAppType_Spot_Whiteboard,
    ZMAppType_SdkMeetingFeature,
...
typedef NS_ENUM(NSInteger, ZAppConsentAction) {
    ...
    ZAppConsentAction_Start_Broadcast_Voice_To_BO,
    ZAppConsentAction_Stop_Broadcast_Voice_To_BO,
    ZAppConsentAction_Delete_Video_Filter,
    ZAppConsentAction_Set_Screen_Name,
    ZAppConsentAction_Set_Participant_Screen_Name,
    ZAppConsentAction_Leave_Meeting,
    ZAppConsentAction_Join_New_Meeting,
    ZAppConsentAction_TurnOn_Video_For_Participants,
    ZAppConsentAction_TurnOff_Video_For_Participants,
    ZAppConsentAction_Enable_WaitingRoom,
    ZAppConsentAction_Disable_WaitingRoom,
    ZAppConsentAction_Put_User_To_WaitingRoom,
    ZAppConsentAction_Admit_User_From_WaitingRoom,
    ZAppConsentAction_Add_Virtual_Background,
    ZAppConsentAction_Delete_Virtual_Background,
    ZAppConsentAction_Get_Data_Virtual_Background,
    ZAppConsentAction_Get_Participants_Email,
    ZAppConsentAction_Leave_Huddle,
    ZAppConsentAction_Be_Requested_Email = 10000, // this is for UI only
};

typedef NS_ENUM(NSInteger, ZAppLeaveMTType) {
    ZAppLeaveMTType_None = 0,
    ZAppLeaveMTType_NotHost,
    ZAppLeaveMTType_HostAssignNewHost,
    ZAppLeaveMTType_HostNotAssignNewHost,
    ZAppLeaveMTType_NotInMeeting_JoinNewMeeting,
    ZAppLeaveMTType_NotHost_JoinNewMeeting,
    ZAppLeaveMTType_HostAssignNewHost_JoinNewMeeting,
    ZAppLeaveMTType_HostNotAssignNewHost_JoinNewMeeting,
};
...
typedef NS_ENUM(NSInteger, ZMZappDockAppAction) {
    ...
    ZMZappDockAppAction_CopyShareLink,
};
...
@property (nonatomic, retain, nullable) NSDictionary *headerDict;
...
@property (nonatomic, copy, nullable) NSString *targetUserName;
@property (nonatomic, copy, nullable) NSString *cameraName;
@property (nonatomic, copy, nullable) NSString *redirectURL;
@property (nonatomic, copy, nullable) NSString *vbFilePath;
...
@property (nonatomic, retain, nullable) NSArray *participantsList;
@property (nonatomic, retain, nullable) NSArray *videoSettingsList;
@property (nonatomic, retain, nullable) NSArray *audioSettingsList;
@property (nonatomic, assign) BOOL isMonoAudio;
@property (nonatomic, copy, nullable) NSString *speakerDevice;
@property (nonatomic, copy, nullable) NSString *micDevice;
@property (nonatomic, assign) double outputVolume;
@property (nonatomic, assign) BOOL isAsyncAction;

@property (nonatomic, retain, nullable) ZMZAppSetMeetingViewInfo *setMeetingViewInfo;
@property (nonatomic, assign) ZAppLeaveMTType leaveMTType;
@property (nonatomic, copy, nullable) NSString *screenName;

@property (nonatomic, copy, nullable) NSString *vbItemName;
@property (nonatomic, copy, nullable) NSString *vbIdentity;

@property (nonatomic, assign) BOOL isHost;
@property (nonatomic, assign) NSUInteger senderNodeId;
@property (nonatomic, copy, nullable) NSString *senderName;
@property (nonatomic, copy, nullable) NSString *emailAddress;
@property (nonatomic, copy, nullable) NSString *reasonForAsking;
@property (nonatomic, assign) NSUInteger userId;
@property (nonatomic, assign) NSUInteger requestSource;
@end
...
@property (nonatomic, retain, nullable) NSImage *avatarImage;
@end
...
@property (nonatomic, retain, nullable) NSString *imageID;
...
@property (nonatomic, retain, nullable) ZMZappDownloadParam *downloadParam;
...
@property (nonatomic, assign) ZMZappLayersCutoutType cutoutType;
@property (nonatomic, retain, nullable) ZMZappConfShareConfigure *configure;
...
@property (nonatomic, copy, nullable) NSString *appId;
@property (nonatomic, copy, nullable) NSString *appName;
@property (nonatomic, retain, nullable) NSImage *thumbnailImg;
@property (nonatomic, retain, nullable) NSImage *appIcon;
@property (nonatomic, copy, nullable) NSString *sentFrom;
@property (nonatomic, retain, nullable) ZMZAppConfShareInfo *shareInfo;
@property (nonatomic, retain, nullable) ZMZAppFilePickerInfo *filePickerInfo;
