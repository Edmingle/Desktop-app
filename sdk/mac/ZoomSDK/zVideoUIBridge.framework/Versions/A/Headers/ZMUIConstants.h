...
typedef NS_ENUM(NSInteger, ZMConfUpdateStrategy) {
    ...
    ZMConfUpdateStrategy_AICPlus_Status_Changed,
...
typedef NS_OPTIONS(NSUInteger, ZMMTContentType){
    ...
    ZMMTContentType_Wallpaper   = 1ll<<20,
    ...
    ZMMTContentType_Practice_Session = 1ll<<31,
    ZMMTContentType_ProctoringMode  = 1ll<<32,
