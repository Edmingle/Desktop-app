...
@property (nonatomic, retain,nullable) ZMLabel *label;
@property (nonatomic, retain,nullable) CAGradientLayer *gradientLayer;
@property (nonatomic) BOOL isHover;
@property (nonatomic, retain,nullable) NSColor *labelColor;
