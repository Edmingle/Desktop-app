...
export const ZoomDirectShareHelper = (function () {
  var instance;
  /**
  ...
  function init(opts) {
    ...
    let _OnDirectShareStatusUpdate =
      clientOpts.OnDirectShareStatusUpdate || null;
    ...
    */
    ...
    return {
       ...
       * @method SetDirectShareStatusUpdateCB
      ...
      SetDirectShareStatusUpdateCB: function (OnDirectShareStatusUpdate) {
        if (
          ...
          OnDirectShareStatusUpdate instanceof Function
        ) {
      ...
      */
      TryWithMeetingNumber: function (opts) {
        if (_addon) {
          ...
          try {
            let TryWithMeetingNumberParams = new pb.TryWithMeetingNumberParams();
      ...
      */
      TryWithPairingCode: function (opts) {
        if (_addon) {
          ...
          try {
            let TryWithPairingCodeParams = new pb.TryWithPairingCodeParams();
