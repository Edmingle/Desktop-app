...
export const ZoomMeetingUICtrl = (function () {
  var instance;
  /**
  ...
  function init(opts) {
    ...
    let _onParticipantListBtnClicked =
      clientOpts.onParticipantListBtnClicked || null;
    let _onCustomLiveStreamMenuClicked =
      clientOpts.onCustomLiveStreamMenuClicked || null;
    ...
    return {
      ...
      MeetingUI_SetInviteButtonClickedCB: function (onInviteBtnClicked) {
        if (
          _addon &&
          onInviteBtnClicked &&
          onInviteBtnClicked instanceof Function
        ) {
      ...
      MeetingUI_SetonStartShareBtnClickedCB: function (onStartShareBtnClicked) {
        if (
          ...
          onStartShareBtnClicked instanceof Function
        ) {
      ...
      MeetingUI_SetonEndMeetingBtnClickedCB: function (onEndMeetingBtnClicked) {
        if (
          ...
          onEndMeetingBtnClicked instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      MeetingUI_SetonParticipantListBtnClickedCB: function (
        onParticipantListBtnClicked,
      ) {
        if (
          _addon &&
          onParticipantListBtnClicked &&
          onParticipantListBtnClicked instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      MeetingUI_SetonCustomLiveStreamMenuClickedCB: function (
        onCustomLiveStreamMenuClicked,
      ) {
        if (
          _addon &&
          onCustomLiveStreamMenuClicked &&
          onCustomLiveStreamMenuClicked instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      MeetingUI_SetonZoomInviteDialogFailedCB: function (
        onZoomInviteDialogFailed,
      ) {
        if (
          _addon &&
          onZoomInviteDialogFailed &&
          onZoomInviteDialogFailed instanceof Function
        ) {
      ...
      MeetingUI_SetonAudioMenuBTNClickedCB: function (onAudioMenuBtnClicked) {
        if (
          ...
          onAudioMenuBtnClicked instanceof Function
        ) {
      ...
      */
      MeetingUI_ShowChatDlg: function (opts) {
        if (_addon) {
          ...
          try {
            let ShowChatDlgParams = new pb.ShowChatDlgParams();
      ...
      */
      MeetingUI_EnterFullScreen: function (opts) {
        if (_addon) {
          ...
          let viewtype =
            clientOpts.viewtype ||
            ZoomMeetingUIViewType.MEETINGUI_FIRST_MONITOR;
          let bFirstView =
            ZoomMeetingUIViewType.MEETINGUI_FIRST_MONITOR == viewtype
              ? true
              : false;
          let bSecView =
            ZoomMeetingUIViewType.MEETINGUI_FIRST_MONITOR == viewtype
              ...
              : true;
          try {
            let EnterFullScreenParams = new pb.EnterFullScreenParams();
        ...
        if (_addon) {
          ...
          let bSecView =
            ZoomMeetingUIViewType.MEETINGUI_FIRST_MONITOR == viewtype
              ...
              : true;
          try {
            let ExitFullScreenParams = new pb.ExitFullScreenParams();
      ...
      */
      MeetingUI_MoveFloatVideoWnd: function (opts) {
        if (_addon) {
          ...
          let top = clientOpts.top || 0;
          try {
            let MoveFloatVideoWndParams = new pb.MoveFloatVideoWndParams();
      ...
      */
      MeetingUI_ShowSharingToolbar: function (opts) {
        if (_addon) {
          ...
          try {
            let ShowSharingToolbarParams = new pb.ShowSharingToolbarParams();
      ...
      */
      MeetingUI_ChangeFloatoActiveSpkVideoSize: function (opts) {
        if (_addon) {
          let clientOpts = opts || {};
          let floatvideotype =
            clientOpts.floatvideotype ||
            ZoomMeetingUIFloatVideoType.FLOATVIDEO_Small;
          try {
            let ChangeFloatoActiveSpkVideoSizeParams =
              new pb.ChangeFloatoActiveSpkVideoSizeParams();
            ChangeFloatoActiveSpkVideoSizeParams.setFloatvideotype(
              floatvideotype,
            );
      ...
      */
      MeetingUI_ShowParticipantsListWnd: function (opts) {
        if (_addon) {
          ...
          let show = clientOpts.show;
          try {
            let ShowParticipantsListWndParams =
              new pb.ShowParticipantsListWndParams();
      ...
      */
      MeetingUI_ShowBottomFloatToolbarWnd: function (opts) {
        if (_addon) {
          ...
          let show = clientOpts.show;
          try {
            let ShowBottomFloatToolbarWndParams =
              new pb.ShowBottomFloatToolbarWndParams();
      ...
      */
      MeetingUI_ShowPreOrNextPageVideo: function (opts) {
        if (_addon) {
          ...
          let show = clientOpts.show;
          try {
            let ShowPreOrNextPageVideoParams =
              new pb.ShowPreOrNextPageVideoParams();
      ...
      */
      MeetingUI_ShowSharingFrameWindows: function (opts) {
        if (_addon) {
          ...
          let show = clientOpts.show;
          try {
            let ShowSharingFrameWindowsParams =
              new pb.ShowSharingFrameWindowsParams();
      ...
      */
      MeetingUI_SwitchSplitScreenMode: function (opts) {
        if (_addon) {
          ...
          try {
            let SwitchSplitScreenModeParams =
              new pb.SwitchSplitScreenModeParams();
      ...
      */
      MeetingUI_SwitchMinimizeUIMode4FristScreenMeetingUIWnd: function (opts) {
        if (_addon) {
          ...
          try {
            let SwitchMinimizeUIMode4FirstScreenMeetingUIWndParams =
              new pb.SwitchMinimizeUIMode4FirstScreenMeetingUIWndParams();
            SwitchMinimizeUIMode4FirstScreenMeetingUIWndParams.setMinimizeuimode(
              mode,
            );
            let bytes =
              SwitchMinimizeUIMode4FirstScreenMeetingUIWndParams.serializeBinary();
      ...
      */
      MeetingUI_SwapToShowShareViewOrVideo: function (opts) {
        if (_addon) {
          ...
          try {
            let SwapToShowShareViewOrVideoParams =
              new pb.SwapToShowShareViewOrVideoParams();
            SwapToShowShareViewOrVideoParams.setBtodisplayshare(
              bToDisplayShare,
            );
      ...
      */
      MeetingUI_SetMeetingTopic: function (opts) {
        if (_addon) {
          ...
          try {
            let SetMeetingTopicParams = new pb.SetMeetingTopicParams();
      ...
      */
      MeetingUI_SetCustomizedCloudRecordingMgrUrl: function (opts) {
        if (_addon) {
          ...
          try {
            let SetCustomizedCloudRecordingMgrUrlParams =
              new pb.SetCustomizedCloudRecordingMgrUrlParams();
            SetCustomizedCloudRecordingMgrUrlParams.setCrmurl(crmURL);
            let bytes =
              SetCustomizedCloudRecordingMgrUrlParams.serializeBinary();
      ...
      */
      MeetingUI_SetCustomizedInvitationDomain: function (opts) {
        if (_addon) {
          ...
          try {
            let SetCustomizedInvitationDomainParams =
              new pb.SetCustomizedInvitationDomainParams();
            SetCustomizedInvitationDomainParams.setInvitationDomain(
              invitationDomain,
            );
      ...
      */
      MeetingUI_SetCustomizedPollingUrl: function (opts) {
        if (_addon) {
          ...
          let bCreate =
            clientOpts.bCreate == undefined ? true : clientOpts.bCreate;
          try {
            let SetCustomizedPollingUrlParams =
              new pb.SetCustomizedPollingUrlParams();
