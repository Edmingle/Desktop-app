...
export const ZoomRawData = (function () {
  let instance;
  /**
   * Zoom Raw Data
   * @module zoom_rawdata
    ...
    return {
      ...
      SetonRawDataStatusChangedCB: function (onRawDataStatusChanged) {
        if (
          _addon &&
          onRawDataStatusChanged &&
          onRawDataStatusChanged instanceof Function
        ) {
      ...
      CreateRenderer: function (opts) {
        if (_addon) {
          ...
          try {
            let CreateRendererParams = new pb.CreateRendererParams();
      ...
      DestroyRenderer: function (opts) {
        if (_addon) {
          ...
          let recv_handle = clientOpts.recv_handle;
          try {
            let DestroyRendererParams = new pb.DestroyRendererParams();
      ...
      Subscribe: function (opts) {
        if (_addon) {
          ...
          let recv_handle = clientOpts.recv_handle;
          try {
            let SubscribeParams = new pb.SubscribeParams();
      ...
      UnSubscribe: function (opts) {
        if (_addon) {
          ...
          let recv_handle = clientOpts.recv_handle;
          try {
            let UnSubscribeParams = new pb.UnSubscribeParams();
      ...
      SetRawDataResolution: function (opts) {
        if (_addon) {
          ...
          let recv_handle = clientOpts.recv_handle;
          try {
            let SetRawDataResolutionParams = new pb.SetRawDataResolutionParams();
      ...
      GetResolution: function (opts) {
        if (_addon) {
          ...
          let recv_handle = clientOpts.recv_handle;
          try {
            let GetResolutionParams = new pb.GetResolutionParams();
      ...
      GetRawDataType: function (opts) {
        if (_addon) {
          ...
          let recv_handle = clientOpts.recv_handle;
          try {
            let GetRawDataTypeParams = new pb.GetRawDataTypeParams();
      ...
      GetUserId: function (opts) {
        if (_addon) {
          ...
          let recv_handle = clientOpts.recv_handle;
          try {
            let GetUserIdParams = new pb.GetUserIdParams();
