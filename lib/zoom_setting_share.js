...
export const ZoomShareSetting = (function () {
  var instance;
  /**
   * Zoom Share Setting
    ...
    return {
      ...
      Setting_EnableAutoFitToWindowWhenViewSharing: function (opts) {
        if (_addon) {
          ...
          try {
            let EnableAutoFitToWindowWhenViewSharingParams =
              new pb.EnableAutoFitToWindowWhenViewSharingParams();
            EnableAutoFitToWindowWhenViewSharingParams.setBenable(bEnable);
            let bytes =
              EnableAutoFitToWindowWhenViewSharingParams.serializeBinary();
      ...
      */
      Setting_EnableAccelerateGPUWhenShare: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableAccelerateGPUWhenShareParams =
              new pb.EnableAccelerateGPUWhenShareParams();
      ...
      */
      Setting_EnableRemoteControlAllApplications: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableRemoteControlAllApplicationsParams =
              new pb.EnableRemoteControlAllApplicationsParams();
            EnableRemoteControlAllApplicationsParams.setBenable(bEnable);
            let bytes =
              EnableRemoteControlAllApplicationsParams.serializeBinary();
