 ...
 * @enum {Number}
 */
export const ZOOM_TYPE_OS_TYPE = {
  WIN_OS: 0,
  MAC_OS: 1,
};
 ...
 * @enum {Number}
 */
export const ZoomSDK_LANGUAGE_ID = {
 ...
 * @enum {Number}
 */
export const ZoomMeetingFailCode = {
 ...
 * @enum {Number}
 */
export const ZoomMeetingUIFloatVideoType = {
  FLOATVIDEO_List: 0,
  FLOATVIDEO_Small: 1,
  FLOATVIDEO_Large: 2,
 ...
 * @enum {Number}
 */
export const ZoomMeetingButtonType = {
 ...
 * @enum {Number}
 */
export const ZoomMeetingUIViewType = {
 ...
 * @enum {Number}
 */
export const ZoomAnnotationToolType = {
 ...
 * @enum {Number}
 */
export const ZoomAnnotationClearType = {
 ...
 * @enum {Number}
 */
export const ZoomMeetingAudioStatus = {
  /** 0, Initialization. */
  Audio_None: 0,
  /** 1, Muted status. */
  Audio_Muted: 1,
 ...
 * @enum {Number}
 */
export const ZoomMeetingVideoStatus = {
  /** 0, Video is on. */
  Video_ON: 0,
  /** 1, Video is off. */
  Video_OFF: 1,
 ...
 * @enum {Number}
 */
export const ZoomH323deviceType = {
 ...
 * @enum {Number}
 */
export const ZoomH323CalloutStatus = {
 ...
 * @enum {Number}
 */
export const RawDataMemoryMode = {
 ...
 * @enum {Number}
 */
export const RawDataResolution = {
 ...
 * @enum {Number}
 */
export const SDKMinimizeUIMode = {
  /** 0, For initialization. */
 ...
 * @enum {Number}
 */
export const SMSVerificationCodeErr = {
  /** 0, For initialization. */
 ...
 * @enum {Number}
 */
export const SDKInviteDlgTabPage = {
 ...
 * @enum {Number}
 */
export const SettingsNetWorkType = {
  /** 0, Wired LAN */
 ...
 * @enum {Number}
 */
export const SettingConnectionType = {
  /** 0, Cloud connection. */
 ...
 * @enum {Number}
 */
export const SDKCustomizedStringType = {
 ...
 * @enum {Number}
 */
export const SDKCustomizedURLType = {
 ...
 * @enum {Number}
 */
export const WebinarNeedRegisterType = {
  /** 0, Initialization. */
  WebinarReg_NONE: 0,
 ...
 * @enum {Number}
 */
export const AudioCallbackActionInfo = {
  /** 0, For initialization. */
  ACTION_INFO_NONE: 0,
 ...
 * @enum {Number}
 */
export const RequestStartCloudRecordingStatus = {
 ...
 * @enum {Number}
 */
export const CustomizedLanguageType = {
  /** 0, No use of the custom resource. */
  CustomizedLanguage_None: 0,
  /** 1, Use the specified file path to assign the custom resource. */
  CustomizedLanguage_FilePath: 1,
 ...
 * @enum {Number}
 */
export const ZoomSDKRawDataType = {
 ...
 * @enum {Number}
 */
export const ZoomSDKVideoRenderMode = {
 ...
 * @enum {Number}
 */
export const SDKRawDataMemoryMode = {
 ...
 * @enum {Number}
 */
export const ZoomSDKVideoCaptureMethod = {
 ...
 * @enum {Number}
 */
export const ZoomSDKRenderPostProcessing = {
 ...
 * @enum {Number}
 */
export const ZoomSDKVideoHardwareEncodeType = {
 ...
 * @enum {Number}
 */
export const ZoomSDKEchoCancelLationLevel = {
 ...
 * @enum {Number}
 */
export const FreeMeetingNeedUpgradeType = {
  /** 0, Initialization. */
 ...
 * @enum {Number}
 */
export const PremeetingAPIResult = {
 ...
 * @enum {Number}
 */
export const StatisticsWarningType = {
  /** 0, No warning. */
 ...
 * @enum {Number}
 */
export const MeetingReminderType = {
 ...
 * @enum {Number}
 */
export const FeatureEnableOption = {
  /** 0, do not enable. */
 ...
 * @enum {Number}
 */
export const SDKChatMessageType = {
  /** 0, For initialize. */
 ...
 * @enum {Number}
 */
export const SDKChatMessageDeleteType = {
  /** 0, none. */
