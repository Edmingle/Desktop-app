...
export const ZoomMeetingVideo = (function () {
  var instance;
  /**
   * Zoom Meeting Video
  ...
  function init(opts) {
    ...
    let _onActiveSpeakerVideoUserChanged =
      clientOpts.onActiveSpeakerVideoUserChanged || null;
    ...
    */
    ...
    if (_addon) {
      ...
      _addon.SetActiveSpeakerVideoUserChangedCB(
    ...
    return {
      ...
      MeetingVideo_SetMeetingVideoStatusCB: function (onUserVideoStatusChange) {
        if (
          ...
          onUserVideoStatusChange instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      MeetingVideo_SetActiveSpeakerVideoUserChangedCB: function (
        onActiveSpeakerVideoUserChanged,
      ) {
        if (
          _addon &&
          onActiveSpeakerVideoUserChanged &&
          onActiveSpeakerVideoUserChanged instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      MeetingVideo_SetActiveVideoUserChangedCB: function (
        onActiveVideoUserChanged,
      ) {
        if (
          _addon &&
          onActiveVideoUserChanged &&
          onActiveVideoUserChanged instanceof Function
        ) {
      ...
      */
      MeetingVideo_MuteVideo: function (opts) {
        if (_addon) {
          ...
          try {
            let MuteVideoParams = new pb.MuteVideoParams();
      ...
      */
      MeetingVideo_UnMuteVideo: function (opts) {
        if (_addon) {
          ...
          let userid = clientOpts.userid;
          try {
            let UnMuteVideoParams = new pb.UnMuteVideoParams();
      ...
      MeetingVideo_PinVideo: function (opts) {
        if (_addon) {
          ...
          let userid = clientOpts.userid;
          try {
            let PinVideoParams = new pb.PinVideoParams();
      ...
      */
      MeetingVideo_SpotlightVideo: function (opts) {
        if (_addon) {
          ...
          let userid = clientOpts.userid;
          try {
            let SpotlightVideoParams = new pb.SpotlightVideoParams();
      ...
      */
      MeetingVideo_HideOrShowNoVideoUserOnVideoWall: function (opts) {
        if (_addon) {
          ...
          try {
            let HideOrShowNoVideoUserOnVideoWallParams =
              new pb.HideOrShowNoVideoUserOnVideoWallParams();
            HideOrShowNoVideoUserOnVideoWallParams.setBhide(bHide);
            let bytes =
              HideOrShowNoVideoUserOnVideoWallParams.serializeBinary();
