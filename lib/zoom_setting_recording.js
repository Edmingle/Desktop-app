...
export const ZoomRecordingSetting = (function () {
  var instance;
  /**
  ...
  function init(opts) {
    ...
    let _onCloudRecordingStorageInfo =
      clientOpts.onCloudRecordingStorageInfo || null;
    ...
    */
    function onCloudRecordingStorageInfo(
      storage_total_size,
      storage_used_size,
      allow_exceed_storage,
    ) {
      if (_onCloudRecordingStorageInfo) {
        _onCloudRecordingStorageInfo(
          storage_total_size,
          storage_used_size,
          allow_exceed_storage,
        );
    ...
    return {
       ...
       * @return {Boolean}
       */
      Setting_SetonCloudRecordingStorageInfoCB: function (
        onCloudRecordingStorageInfo,
      ) {
        if (
          _addon &&
          onCloudRecordingStorageInfo &&
          onCloudRecordingStorageInfo instanceof Function
        ) {
      ...
      */
      Setting_SetRecordingPath: function (opts) {
        if (_addon) {
          ...
          try {
            let SetRecordingPathParams = new pb.SetRecordingPathParams();
      ...
      */
      Setting_EnableSelectRecordFileLocationAfterMeeting: function (opts) {
        if (_addon) {
          ...
          try {
            let EnableSelectRecordFileLocationAfterMeetingParams =
              new pb.EnableSelectRecordFileLocationAfterMeetingParams();
            EnableSelectRecordFileLocationAfterMeetingParams.setBenable(
              bEnable,
            );
            let bytes =
              EnableSelectRecordFileLocationAfterMeetingParams.serializeBinary();
      ...
      */
      Setting_EnableMultiAudioStreamRecord: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableMultiAudioStreamRecordParams =
              new pb.EnableMultiAudioStreamRecordParams();
      ...
      */
      Setting_EnableAddTimestampWatermark: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableAddTimestampWatermarkParams =
              new pb.EnableAddTimestampWatermarkParams();
      ...
      */
      Setting_EnableOptimizeFor3rdPartyVideoEditor: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableOptimizeFor3rdPartyVideoEditorParams =
              new pb.EnableOptimizeFor3rdPartyVideoEditorParams();
            EnableOptimizeFor3rdPartyVideoEditorParams.setBenable(bEnable);
            let bytes =
              EnableOptimizeFor3rdPartyVideoEditorParams.serializeBinary();
      ...
      */
      Setting_EnableShowVideoThumbnailWhenShare: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableShowVideoThumbnailWhenShareParams =
              new pb.EnableShowVideoThumbnailWhenShareParams();
            EnableShowVideoThumbnailWhenShareParams.setBenable(bEnable);
            let bytes =
              EnableShowVideoThumbnailWhenShareParams.serializeBinary();
      ...
      */
      Setting_EnablePlaceVideoNextToShareInRecord: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnablePlaceVideoNextToShareInRecordParams =
              new pb.EnablePlaceVideoNextToShareInRecordParams();
            EnablePlaceVideoNextToShareInRecordParams.setBenable(bEnable);
            let bytes =
              EnablePlaceVideoNextToShareInRecordParams.serializeBinary();
