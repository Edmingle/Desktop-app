import { ZoomSDKError, AudioShareMode } from "./settings";
import pb from "./electron_sdk_pb";

export const ZoomMeetingShare = (function () {
  var instance;
  /**
   * Zoom Meeting Share
      ...
      */
      MeetingShare_StartAppShare: function (opts) {
        if (_addon) {
          ...
          try {
            let StartAppShareParams = new pb.StartAppShareParams();
      ...
      */
      MeetingShare_StartMonitorShare: function (opts) {
        if (_addon) {
          ...
          try {
            let StartMonitorShareParams = new pb.StartMonitorShareParams();
      ...
      */
      MeetingShare_SetAudioShareMode: function (opts) {
        if (_addon) {
          ...
          try {
            let SetAudioShareModeParams = new pb.SetAudioShareModeParams();
