...
export const ZoomMeetingConfiguration = (function () {
  var instance;
  /**
   ...
   * @param {Function} onWebinarNeedInputScreenName When join the webinar, this callback will be triggered if the user needs to input username.
  ...
  function init(opts) {
    ...
    let _onFreeMeetingNeedToUpgrade =
      clientOpts.onFreeMeetingNeedToUpgrade || null;
    let _onFreeMeetingUpgradeToGiftFreeTrialStart =
      clientOpts.onFreeMeetingUpgradeToGiftFreeTrialStart || null;
    let _onFreeMeetingUpgradeToGiftFreeTrialStop =
      clientOpts.onFreeMeetingUpgradeToGiftFreeTrialStop || null;
    let _onFreeMeetingUpgradeToProMeeting =
      clientOpts.onFreeMeetingUpgradeToProMeeting || null;
    let _onInputMeetingPasswordAndScreenNameNotification =
      clientOpts.onInputMeetingPasswordAndScreenNameNotification || null;
    let _onAirPlayInstructionWndNotification =
      clientOpts.onAirPlayInstructionWndNotification || null;
    let _onWebinarNeedRegisterNotification =
      clientOpts.onWebinarNeedRegisterNotification || null;
    let _onEndOtherMeetingToJoinMeetingNotification =
      clientOpts.onEndOtherMeetingToJoinMeetingNotification || null;
    let _onFreeMeetingRemainTime = clientOpts.onFreeMeetingRemainTime || null;
    let _onFreeMeetingRemainTimeStopCountDown =
      clientOpts.onFreeMeetingRemainTimeStopCountDown || null;
    let _onWebinarNeedInputScreenName =
      clientOpts.onWebinarNeedInputScreenName || null;
    ...
    */
    ...
    /**
      ...
      @event onWebinarNeedInputScreenName
    */
    function onWebinarNeedInputScreenName() {
      if (_onWebinarNeedInputScreenName) {
        _onWebinarNeedInputScreenName();
      }
    }

    if (_addon) {
      _addon.SetFreeMeetingNeedToUpgradeCB(onFreeMeetingNeedToUpgrade);
      _addon.SetFreeMeetingUpgradeToGiftFreeTrialStartCB(
        onFreeMeetingUpgradeToGiftFreeTrialStart,
      );
      _addon.SetFreeMeetingUpgradeToGiftFreeTrialStopCB(
        onFreeMeetingUpgradeToGiftFreeTrialStop,
      );
      _addon.SetFreeMeetingUpgradeToProMeetingCB(
        onFreeMeetingUpgradeToProMeeting,
      );
      _addon.SetInputMeetingPasswordAndScreenNameNotificationCB(
        onInputMeetingPasswordAndScreenNameNotification,
      );
      _addon.SetAirPlayInstructionWndNotificationCB(
        onAirPlayInstructionWndNotification,
      );
      _addon.SetonWebinarNeedRegisterNotificationCB(
        onWebinarNeedRegisterNotification,
      );
      _addon.SetonEndOtherMeetingToJoinMeetingNotificationCB(
        onEndOtherMeetingToJoinMeetingNotification,
      );
      _addon.SetonFreeMeetingRemainTimeCB(onFreeMeetingRemainTime);
      _addon.SetonFreeMeetingRemainTimeStopCountDownCB(
    ...
    return {
      ...
      MeetingConfig_SetFreeMeetingNeedToUpgradeCB: function (
        ...
        if (
          _addon &&
          onFreeMeetingNeedToUpgrade &&
          onFreeMeetingNeedToUpgrade instanceof Function
        ) {
      ...
      MeetingConfig_SetFreeMeetingUpgradeToGiftFreeTrialStartCB: function (
        ...
        if (
          _addon &&
          onFreeMeetingUpgradeToGiftFreeTrialStart &&
          onFreeMeetingUpgradeToGiftFreeTrialStart instanceof Function
        ) {
          _onFreeMeetingUpgradeToGiftFreeTrialStart =
            onFreeMeetingUpgradeToGiftFreeTrialStart;
          return true;
      ...
      MeetingConfig_SetFreeMeetingUpgradeToGiftFreeTrialStopCB: function (
        ...
        if (
          _addon &&
          onFreeMeetingUpgradeToGiftFreeTrialStop &&
          onFreeMeetingUpgradeToGiftFreeTrialStop instanceof Function
        ) {
          _onFreeMeetingUpgradeToGiftFreeTrialStop =
            onFreeMeetingUpgradeToGiftFreeTrialStop;
          return true;
      ...
      MeetingConfig_SetFreeMeetingUpgradeToProMeetingCB: function (
        ...
        if (
          _addon &&
          onFreeMeetingUpgradeToProMeeting &&
          onFreeMeetingUpgradeToProMeeting instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      MeetingConfig_SetInputMeetingPasswordAndScreenNameNotificationCB:
        function (onInputMeetingPasswordAndScreenNameNotification) {
          if (
            _addon &&
            onInputMeetingPasswordAndScreenNameNotification &&
            onInputMeetingPasswordAndScreenNameNotification instanceof Function
          ) {
            _onInputMeetingPasswordAndScreenNameNotification =
              onInputMeetingPasswordAndScreenNameNotification;
            return true;
       ...
       * @return {Boolean}
       */
      MeetingConfig_SetAirPlayInstructionWndNotificationCB: function (
        onAirPlayInstructionWndNotification,
      ) {
        if (
          _addon &&
          onAirPlayInstructionWndNotification &&
          onAirPlayInstructionWndNotification instanceof Function
        ) {
          _onAirPlayInstructionWndNotification =
            onAirPlayInstructionWndNotification;
          return true;
        }
        return false;
       ...
       * @return {Boolean}
       */
      MeetingConfig_SetonWebinarNeedRegisterNotificationCB: function (
        onWebinarNeedRegisterNotification,
      ) {
        if (
          _addon &&
          onWebinarNeedRegisterNotification &&
          onWebinarNeedRegisterNotification instanceof Function
        ) {
          _onWebinarNeedRegisterNotification =
            onWebinarNeedRegisterNotification;
          return true;
       ...
       * @return {Boolean}
       */
      MeetingConfig_SetonEndOtherMeetingToJoinMeetingNotificationCB: function (
        onEndOtherMeetingToJoinMeetingNotification,
      ) {
        if (
          _addon &&
          onEndOtherMeetingToJoinMeetingNotification &&
          onEndOtherMeetingToJoinMeetingNotification instanceof Function
        ) {
          _onEndOtherMeetingToJoinMeetingNotification =
            onEndOtherMeetingToJoinMeetingNotification;
          return true;
       ...
       * @return {Boolean}
       */
      MeetingConfig_SetonFreeMeetingRemainTimeCB: function (
        onFreeMeetingRemainTime,
      ) {
        if (
          _addon &&
          onFreeMeetingRemainTime &&
          onFreeMeetingRemainTime instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      MeetingConfig_SetonFreeMeetingRemainTimeStopCountDownCB: function (
        onFreeMeetingRemainTimeStopCountDown,
      ) {
        if (
          _addon &&
          onFreeMeetingRemainTimeStopCountDown &&
          onFreeMeetingRemainTimeStopCountDown instanceof Function
        ) {
          _onFreeMeetingRemainTimeStopCountDown =
            onFreeMeetingRemainTimeStopCountDown;
          return true;
       ...
       * @return {Boolean}
       */
      MeetingConfig_SetonWebinarNeedInputScreenNameCB: function (
        onWebinarNeedInputScreenName,
      ) {
        if (
          _addon &&
          onWebinarNeedInputScreenName &&
          onWebinarNeedInputScreenName instanceof Function
        ) {
      ...
      MeetingConfig_EnableInviteButtonOnMeetingUI: function (opts) {
        if (_addon) {
          ...
          try {
            let EnableInviteButtonOnMeetingUIParams =
              new pb.EnableInviteButtonOnMeetingUIParams();
      ...
      MeetingConfig_SetFloatVideoPos: function (opts) {
        if (_addon) {
          ...
          try {
            let SetFloatVideoPosParams = new pb.SetFloatVideoPosParams();
      ...
      MeetingConfig_SetBottomFloatToolbarWndVisibility: function (opts) {
        if (_addon) {
          ...
          try {
            let SetBottomFloatToolBarWndVisibilityParams =
              new pb.SetBottomFloatToolBarWndVisibilityParams();
            SetBottomFloatToolBarWndVisibilityParams.setBshow(bShow);
            let bytes =
              SetBottomFloatToolBarWndVisibilityParams.serializeBinary();
      ...
      MeetingConfig_SetSharingToolbarVisibility: function (opts) {
        if (_addon) {
          ...
          let bShow = clientOpts.bShow;
          try {
            let SetSharingToolBarVisibilityParams =
              new pb.SetSharingToolBarVisibilityParams();
      ...
      MeetingConfig_SetDirectShareMonitorID: function (opts) {
        if (_addon) {
          ...
          try {
            let SetDirectShareMonitorIDParams =
              new pb.SetDirectShareMonitorIDParams();
      ...
      MeetingConfig_SetMeetingUIPos: function (opts) {
        if (_addon) {
          ...
          let hParent = clientOpts.hParent || "0";
          try {
            let SetMeetingUIPosParams = new pb.SetMeetingUIPosParams();
      ...
      MeetingConfig_DisableWaitingForHostDialog: function (opts) {
        if (_addon) {
          ...
          try {
            let DisableWaitingForHostDialogParams =
              new pb.DisableWaitingForHostDialogParams();
      ...
      MeetingConfig_DisablePopupMeetingWrongPSWDlg: function (opts) {
        if (_addon) {
          ...
          let bDisable = clientOpts.bDisable;
          try {
            let DisablePopupMeetingWrongPSWDlgParams =
              new pb.DisablePopupMeetingWrongPSWDlgParams();
      ...
      MeetingConfig_EnableAutoEndOtherMeetingWhenStartMeeting: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableAutoEndOtherMeetingWhenStartMeetingParams =
              new pb.EnableAutoEndOtherMeetingWhenStartMeetingParams();
            EnableAutoEndOtherMeetingWhenStartMeetingParams.setBenable(bEnable);
            let bytes =
              EnableAutoEndOtherMeetingWhenStartMeetingParams.serializeBinary();
      ...
      MeetingConfig_EnableLButtonDBClick4SwitchFullScreenMode: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableLButtonDBClick4SwitchFullScreenModeParams =
              new pb.EnableLButtonDBClick4SwitchFullScreenModeParams();
            EnableLButtonDBClick4SwitchFullScreenModeParams.setBenable(bEnable);
            let bytes =
              EnableLButtonDBClick4SwitchFullScreenModeParams.serializeBinary();
      ...
      MeetingConfig_SetFloatVideoWndVisibility: function (opts) {
        if (_addon) {
          ...
          let bShow = clientOpts.bShow;
          try {
            let SetFloatVideoWndVisibilityParams =
              new pb.SetFloatVideoWndVisibilityParams();
      ...
      MeetingConfig_PrePopulateWebinarRegistrationInfo: function (opts) {
        if (_addon) {
          ...
          try {
            let PrePopulateWebinarRegistrationInfoParams =
              new pb.PrePopulateWebinarRegistrationInfoParams();
            PrePopulateWebinarRegistrationInfoParams.setEmail(email);
            PrePopulateWebinarRegistrationInfoParams.setUsername(userName);
            let bytes =
              PrePopulateWebinarRegistrationInfoParams.serializeBinary();
       ...
       * @return {Number} Defined in: {@link ZoomSDKError}
       */
      MeetingConfig_EnableAutoAdjustSpeakerVolumeWhenJoinAudio: function (
        opts,
      ) {
        if (_addon) {
          let clientOpts = opts || {};
          let bEnable = clientOpts.bEnable;
          try {
            let EnableAutoAdjustSpeakerVolumeWhenJoinAudioParams =
              new pb.EnableAutoAdjustSpeakerVolumeWhenJoinAudioParams();
            EnableAutoAdjustSpeakerVolumeWhenJoinAudioParams.setBenable(
              bEnable,
            );
            let bytes =
              EnableAutoAdjustSpeakerVolumeWhenJoinAudioParams.serializeBinary();
      ...
      MeetingConfig_EnableAutoAdjustMicVolumeWhenJoinAudio: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableAutoAdjustMicVolumeWhenJoinAudioParams =
              new pb.EnableAutoAdjustMicVolumeWhenJoinAudioParams();
            EnableAutoAdjustMicVolumeWhenJoinAudioParams.setBenable(bEnable);
            let bytes =
              EnableAutoAdjustMicVolumeWhenJoinAudioParams.serializeBinary();
      ...
      MeetingConfig_ConfigDSCP: function (opts) {
        if (_addon) {
          ...
          try {
            let ConfigDSCPParams = new pb.ConfigDSCPParams();
      ...
      MeetingConfig_EnableLengthLimitationOfMeetingNumber: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableLengthLimitationOfMeetingNumberParams =
              new pb.EnableLengthLimitationOfMeetingNumberParams();
            EnableLengthLimitationOfMeetingNumberParams.setBenable(bEnable);
            let bytes =
              EnableLengthLimitationOfMeetingNumberParams.serializeBinary();
      ...
      MeetingConfig_EnableShareIOSDevice: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableShareIOSDeviceParams =
              new pb.EnableShareIOSDeviceParams();
      ...
      MeetingConfig_EnableShareWhiteBoard: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableShareWhiteBoardParams =
              new pb.EnableShareWhiteBoardParams();
      ...
      MeetingConfig_ForceDisableMultiShare: function (opts) {
        if (_addon) {
          ...
          let bDisable = clientOpts.bDisable;
          try {
            let ForceDisableMultiShareParams =
              new pb.ForceDisableMultiShareParams();
      ...
      MeetingConfig_SetMaxDurationForOnlyHostInMeeting: function (opts) {
        if (_addon) {
          ...
          try {
            let SetMaxDurationForOnlyHostInMeetingParams =
              new pb.SetMaxDurationForOnlyHostInMeetingParams();
            SetMaxDurationForOnlyHostInMeetingParams.setNduration(nDuration);
            let bytes =
              SetMaxDurationForOnlyHostInMeetingParams.serializeBinary();
       ...
       * @return {Number} Defined in: {@link ZoomSDKError}
       */
      MeetingConfig_EnableLocalRecordingConvertProgressBarDialog: function (
        opts,
      ) {
        if (_addon) {
          let clientOpts = opts || {};
          let bShow = clientOpts.bShow;
          try {
            let EnableLocalRecordingConverProgressBarDialogParams =
              new pb.EnableLocalRecordingConverProgressBarDialogParams();
            EnableLocalRecordingConverProgressBarDialogParams.setBenable(bShow);
            let bytes =
              EnableLocalRecordingConverProgressBarDialogParams.serializeBinary();
      ...
      MeetingConfig_EnableApproveRemoteControlDlg: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableApproveRemoteControlDlgParams =
              new pb.EnableApproveRemoteControlDlgParams();
      ...
      MeetingConfig_EnableDeclineRemoteControlResponseDlg: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableDeclineRemoteControlResponseDlgParams =
              new pb.EnableDeclineRemoteControlResponseDlgParams();
            EnableDeclineRemoteControlResponseDlgParams.setBenable(bEnable);
            let bytes =
              EnableDeclineRemoteControlResponseDlgParams.serializeBinary();
      ...
      MeetingConfig_EnableLeaveMeetingOptionForHost: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableLeaveMeetingOptionForHostParams =
              new pb.EnableLeaveMeetingOptionForHostParams();
      ...
      MeetingConfig_EnableVideoButtonOnMeetingUI: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableVideoButtonOnMeetingUIParams =
              new pb.EnableVideoButtonOnMeetingUIParams();
       ...
       * @return {Number} Defined in: {@link ZoomSDKError}
       */
      MeetingConfig_EnableEnterAndExitFullScreenButtonOnMeetingUI: function (
        opts,
      ) {
        if (_addon) {
          let clientOpts = opts || {};
          let bEnable = clientOpts.bEnable;
          try {
            let EnableEnterAndExitFullScreenButtonOnMeetingUIParams =
              new pb.EnableEnterAndExitFullScreenButtonOnMeetingUIParams();
            EnableEnterAndExitFullScreenButtonOnMeetingUIParams.setBenable(
              bEnable,
            );
            let bytes =
              EnableEnterAndExitFullScreenButtonOnMeetingUIParams.serializeBinary();
      ...
      MeetingConfig_RedirectClickShareBTNEvent: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let RedirectClickShareBTNEventParams =
              new pb.RedirectClickShareBTNEventParams();
      ...
      MeetingConfig_RedirectClickEndMeetingBTNEvent: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let RedirectClickEndMeetingBTNEventParams =
              new pb.RedirectClickEndMeetingBTNEventParams();
      ...
      MeetingConfig_RedirectFreeMeetingEndingReminderDlg: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let RedirectFreeMeetingEndingReminderDlgParams =
              new pb.RedirectFreeMeetingEndingReminderDlgParams();
            RedirectFreeMeetingEndingReminderDlgParams.setBredirect(bEnable);
            let bytes =
              RedirectFreeMeetingEndingReminderDlgParams.serializeBinary();
      ...
      MeetingConfig_RedirectClickCustomLiveStreamMenuEvent: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let RedirectClickCustomLiveStreamMenuEventParams =
              new pb.RedirectClickCustomLiveStreamMenuEventParams();
            RedirectClickCustomLiveStreamMenuEventParams.setBredirect(bEnable);
            let bytes =
              RedirectClickCustomLiveStreamMenuEventParams.serializeBinary();
      ...
      MeetingConfig_RedirectClickParticipantListBTNEvent: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let RedirectClickParticipantListBTNEventParams =
              new pb.RedirectClickParticipantListBTNEventParams();
            RedirectClickParticipantListBTNEventParams.setBredirect(bEnable);
            let bytes =
              RedirectClickParticipantListBTNEventParams.serializeBinary();
      ...
      MeetingConfig_RedirectClickCCBTNEvent: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let RedirectClickCCBTNEventParams =
              new pb.RedirectClickCCBTNEventParams();
      ...
      MeetingConfig_RedirectMeetingWarningMsg: function (opts) {
        if (_addon) {
          ...
          try {
            let RedirectMeetingWarningMsgParams =
              new pb.RedirectMeetingWarningMsgParams();
            RedirectMeetingWarningMsgParams.setBredirectbadnetwork(
              bRedirectBadNetwork,
            );
            RedirectMeetingWarningMsgParams.setBredirectwarnhighcpu(
      ...
      MeetingConfig_EnableToolTipsShow: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableToolTipsShowParams = new pb.EnableToolTipsShowParams();
      ...
      MeetingConfig_EnableClaimHostFeature: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableClaimHostFeatureParams =
              new pb.EnableClaimHostFeatureParams();
      ...
      MeetingConfig_EnableAutoHideJoinAudioDialog: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableAutoHideJoinAudioDialogParams =
              new pb.EnableAutoHideJoinAudioDialogParams();
      ...
      MeetingConfig_AlwaysShowIconOnTaskBar: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let AlwaysShowIconOnTaskBarParams =
              new pb.AlwaysShowIconOnTaskBarParams();
      ...
      MeetingConfig_DisableSplitScreenModeUIElements: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let DisableSplitScreenModeUIElementsParams =
              new pb.DisableSplitScreenModeUIElementsParams();
            DisableSplitScreenModeUIElementsParams.setBdisable(bEnable);
            let bytes =
              DisableSplitScreenModeUIElementsParams.serializeBinary();
      ...
      MeetingConfig_SetShowAudioUseComputerSoundChkbox: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let SetShowAudioUseComputerSoundChkboxParams =
              new pb.SetShowAudioUseComputerSoundChkboxParams();
            SetShowAudioUseComputerSoundChkboxParams.setBshow(bEnable);
            let bytes =
              SetShowAudioUseComputerSoundChkboxParams.serializeBinary();
      ...
      MeetingConfig_SetShowCallInTab: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let SetShowCallInTabParams = new pb.SetShowCallInTabParams();
      ...
      MeetingConfig_SetShowCallMeTab: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let SetShowCallMeTabParams = new pb.SetShowCallMeTabParams();
      ...
      MeetingConfig_DisableTopMostAttr4SettingDialog: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let DisableTopMostAttr4SettingDialogParams =
              new pb.DisableTopMostAttr4SettingDialogParams();
            DisableTopMostAttr4SettingDialogParams.setBdisable(bEnable);
            let bytes =
              DisableTopMostAttr4SettingDialogParams.serializeBinary();
      ...
      MeetingConfig_EnableGrabShareWithoutReminder: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableGrabShareWithoutReminderParams =
              new pb.EnableGrabShareWithoutReminderParams();
       ...
       * @return {Number} Defined in: {@link ZoomSDKError}
       */
      MeetingConfig_EnableShowShareSwitchMultiToSingleConfirmDlg: function (
        opts,
      ) {
        if (_addon) {
          let clientOpts = opts || {};
          let bEnable = clientOpts.bEnable;
          try {
            let EnableShowShareSwitchMultiToSingleConfirmDlgParams =
              new pb.EnableShowShareSwitchMultiToSingleConfirmDlgParams();
            EnableShowShareSwitchMultiToSingleConfirmDlgParams.setBenable(
              bEnable,
            );
            let bytes =
              EnableShowShareSwitchMultiToSingleConfirmDlgParams.serializeBinary();
      ...
      MeetingConfig_DisableFreeMeetingRemainTimeNotify: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let DisableFreeMeetingRemainTimeNotifyParams =
              new pb.DisableFreeMeetingRemainTimeNotifyParams();
            DisableFreeMeetingRemainTimeNotifyParams.setBdisable(bEnable);
            let bytes =
              DisableFreeMeetingRemainTimeNotifyParams.serializeBinary();
      ...
      MeetingConfig_HideChatItemOnMeetingUI: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let HideChatItemOnMeetingUIParams =
              new pb.HideChatItemOnMeetingUIParams();
      ...
      MeetingConfig_HideRecordItemOnMeetingUI: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let HideRecordItemOnMeetingUIParams =
              new pb.HideRecordItemOnMeetingUIParams();
      ...
      MeetingConfig_HideUpgradeFreeMeetingButton: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let HideUpgradeFreeMeetingButtonParams =
              new pb.HideUpgradeFreeMeetingButtonParams();
      ...
      MeetingConfig_SetShowInviteDlgTabPage: function (opts) {
        if (_addon) {
          ...
          let bShow = clientOpts.bShow;
          try {
            let SetShowInviteDlgTabPageParams =
              new pb.SetShowInviteDlgTabPageParams();
      ...
      MeetingConfig_SetShowH323SubTabPage: function (opts) {
        if (_addon) {
          ...
          let bShow = clientOpts.bShow;
          try {
            let SetShowH323SubTabPageParams =
              new pb.SetShowH323SubTabPageParams();
      ...
      MeetingConfig_HideSwitchCameraButton: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let HideSwitchCameraButtonParams =
              new pb.HideSwitchCameraButtonParams();
      ...
      MeetingConfig_HideCopyUrlOnInviteWindow: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let HideCopyUrlOnInviteWindowParams =
              new pb.HideCopyUrlOnInviteWindowParams();
      ...
      MeetingConfig_HideCopyInvitationOnInviteWindow: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let HideCopyInvitationOnInviteWindowParams =
              new pb.HideCopyInvitationOnInviteWindowParams();
            HideCopyInvitationOnInviteWindowParams.setBhide(bEnable);
            let bytes =
              HideCopyInvitationOnInviteWindowParams.serializeBinary();
      ...
      MeetingConfig_HideKeypadButtonOnMeetingWindow: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let HideKeypadButtonOnMeetingWindowParams =
              new pb.HideKeypadButtonOnMeetingWindowParams();
      ...
      MeetingConfig_HideRemoteControlOnMeetingUI: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let HideRemoteControlOnMeetingUIParams =
              new pb.HideRemoteControlOnMeetingUIParams();
      ...
      MeetingConfig_HideQAOnMeetingUI: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let HideQAOnMeetingUIParams = new pb.HideQAOnMeetingUIParams();
      ...
      MeetingConfig_HidePollOnMeetingUI: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let HidePollOnMeetingUIParams = new pb.HidePollOnMeetingUIParams();
      ...
      MeetingConfig_EnableInputMeetingPasswordDlg: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableInputMeetingPasswordDlgParams =
              new pb.EnableInputMeetingPasswordDlgParams();
      ...
      MeetingConfig_EnableInputMeetingScreenNameDlg: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableInputMeetingScreenNameDlgParams =
              new pb.EnableInputMeetingScreenNameDlgParams();
      ...
      MeetingConfig_RedirectWebinarNeedRegister: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let RedirectWebinarNeedRegisterParams =
              new pb.RedirectWebinarNeedRegisterParams();
      ...
      MeetingConfig_RedirectEndOtherMeeting: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let RedirectEndOtherMeetingParams =
              new pb.RedirectEndOtherMeetingParams();
       ...
       * @return {Number} Defined in: {@link ZoomSDKError}
       */
      MeetingConfig_EnableForceAutoStartMyVideoWhenJoinMeeting: function (
        opts,
      ) {
        if (_addon) {
          let clientOpts = opts || {};
          let bEnable = clientOpts.bEnable;
          try {
            let EnableForceAutoStartMyVideoWhenJoinMeetingParams =
              new pb.EnableForceAutoStartMyVideoWhenJoinMeetingParams();
            EnableForceAutoStartMyVideoWhenJoinMeetingParams.setBenable(
              Boolean(bEnable),
            );
            let bytes =
              EnableForceAutoStartMyVideoWhenJoinMeetingParams.serializeBinary();
      ...
      MeetingConfig_EnableForceAutoStopMyVideoWhenJoinMeeting: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableForceAutoStopMyVideoWhenJoinMeetingParams =
              new pb.EnableForceAutoStopMyVideoWhenJoinMeetingParams();
            EnableForceAutoStopMyVideoWhenJoinMeetingParams.setBenable(
              Boolean(bEnable),
            );
            let bytes =
              EnableForceAutoStopMyVideoWhenJoinMeetingParams.serializeBinary();
       ...
       * @return {Number} Defined in: {@link ZoomSDKError}
       */
      MeetingConfig_DisableAutoShowSelectJoinAudioDlgWhenJoinMeeting: function (
        opts,
      ) {
        if (_addon) {
          let clientOpts = opts || {};
          let bEnable = clientOpts.bEnable;
          try {
            let DisableAutoShowSelectJoinAudioDlgWhenJoinMeetingParams =
              new pb.DisableAutoShowSelectJoinAudioDlgWhenJoinMeetingParams();
            DisableAutoShowSelectJoinAudioDlgWhenJoinMeetingParams.setBdisable(
              Boolean(bEnable),
            );
            let bytes =
              DisableAutoShowSelectJoinAudioDlgWhenJoinMeetingParams.serializeBinary();
            return _addon.DisableAutoShowSelectJoinAudioDlgWhenJoinMeeting(
              bytes,
            );
          } catch (error) {
            return ZoomSDKError.SDKERR_INVALID_PARAMETER;
      ...
      MeetingConfig_SetShowVideoOptimizeChkbox: function (opts) {
        if (_addon) {
          ...
          let bShow = clientOpts.bShow;
          try {
            let SetShowVideoOptimizeChkboxParams =
              new pb.SetShowVideoOptimizeChkboxParams();
      ...
      MeetingConfig_InputMeetingPasswordAndScreenName: function (opts) {
        if (_addon) {
          ...
          try {
            let InputMeetingPasswordAndScreenNameParams =
              new pb.InputMeetingPasswordAndScreenNameParams();
            ...
            let bytes =
              InputMeetingPasswordAndScreenNameParams.serializeBinary();
      ...
      MeetingConfig_InputMeetingIDAndScreenName: function (opts) {
        if (_addon) {
          ...
          let screenName = clientOpts.screenName;
          try {
            let InputMeetingIDAndScreenNameParams =
              new pb.InputMeetingIDAndScreenNameParams();
      ...
      MeetingConfig_InputMeetingScreenName: function (opts) {
        if (_addon) {
          ...
          let screenName = clientOpts.screenName;
          try {
            let InputMeetingScreenNameParams =
              new pb.InputMeetingScreenNameParams();
      ...
      MeetingConfig_InputWebinarRegisterEmailAndScreenName: function (opts) {
        if (_addon) {
          ...
          let screenName = clientOpts.screenName;
          try {
            let InputWebinarRegisterEmailAndScreenNameParams =
              new pb.InputWebinarRegisterEmailAndScreenNameParams();
            InputWebinarRegisterEmailAndScreenNameParams.setEmail(email);
            InputWebinarRegisterEmailAndScreenNameParams.setScreenname(
              screenName,
            );
            let bytes =
              InputWebinarRegisterEmailAndScreenNameParams.serializeBinary();
      ...
      MeetingConfig_RedirectClickAudioBTNEvent: function (opts) {
        if (_addon) {
          ...
          try {
            let RedirectClickAudioBTNEventParams =
              new pb.RedirectClickAudioBTNEventParams();
      ...
      MeetingConfig_RedirectClickAudioMenuBTNEvent: function (opts) {
        if (_addon) {
          ...
          let bRedirect = clientOpts.bRedirect;
          try {
            let RedirectClickAudioMenuBTNEventParams =
              new pb.RedirectClickAudioMenuBTNEventParams();
      ...
      MeetingConfig_EnableAudioButtonOnMeetingUI: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableAudioButtonOnMeetingUIParams =
              new pb.EnableAudioButtonOnMeetingUIParams();
      ...
      MeetingConfig_DisableShowJoinMeetingWnd: function (opts) {
        if (_addon) {
          ...
          let bDisable = clientOpts.bDisable;
          try {
            let DisableShowJoinMeetingWndParams =
              new pb.DisableShowJoinMeetingWndParams();
       ...
       * @return {Number}
       */
      MeetingConfig_DisableToolbarInviteButtonClickOriginAction: function (
        opts,
      ) {
        if (platform == "darwin" && _addon) {
          ...
          let bDisable = clientOpts.bDisable;
          try {
            let DisableToolbarInviteButtonClickOriginActionParams =
              new pb.DisableToolbarInviteButtonClickOriginActionParams();
            DisableToolbarInviteButtonClickOriginActionParams.setBdisable(
              bDisable,
            );
            let bytes =
              DisableToolbarInviteButtonClickOriginActionParams.serializeBinary();
      ...
      MeetingConfig_EnableInviteLinkOnMeetingUI: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableInviteLinkOnMeetingUIParams =
              new pb.EnableInviteLinkOnMeetingUIParams();
      ...
      MeetingConfig_InputScreenName: function (opts) {
        if (_addon) {
          ...
          let screenName = clientOpts.screenName;
          try {
            let InputScreenNameParams = new pb.InputScreenNameParams();
