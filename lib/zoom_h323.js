...
export const ZoomH323 = (function () {
  var instance;
  ...
  function init(opts) {
    ...
    */
    function onH323CalloutStatusNotify(status) {
      if (null != _calloutstatuscb) _calloutstatuscb(status);
    }
      ...
      */
      H323_CallOutH323: function (opts) {
        if (_addon) {
          ...
          try {
            let CallOutH323Params = new pb.CallOutH323Params();
      ...
      H323_GetH323Password: function () {
        if (_addon) return _addon.GetH323Password();
        return ZoomSDKError.SDKERR_UNINITIALIZE;
      },
      /**
