...
export const ZoomCustomizedResource = (function () {
  var instance;
  /**
    ...
    return {
      ...
      Resource_AddCustomizedPictureResource: function (opts) {
        if (_addon) {
          ...
          try {
            let AddCustomizedPictureResourceParams =
              new pb.AddCustomizedPictureResourceParams();
      ...
      Resource_AddCustomizedStringResource: function (opts) {
        if (_addon) {
          ...
          try {
            let AddCustomizedStringResourceParams =
              new pb.AddCustomizedStringResourceParams();
            AddCustomizedStringResourceParams.setCustomizedstringtype(
              CustomizedStringType
            );
            AddCustomizedStringResourceParams.setStrcustomizedstring(
              strCustomizedString
            );
      ...
      Resource_AddCustomizedURLResource: function (opts) {
        if (_addon) {
          ...
          try {
            let AddCustomizedURLResourceParams =
              new pb.AddCustomizedURLResourceParams();
            AddCustomizedURLResourceParams.setCustomizedurltype(
              CustomizedURLType
            );
