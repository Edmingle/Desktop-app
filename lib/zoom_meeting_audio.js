...
export const ZoomMeetingAudio = (function () {
  var instance;
  /**
   * Zoom Meeting Audio
    ...
    return {
      ...
      MeetingAudio_SetMeetingAudioStatusCB: function (onUserAudioStatusChange) {
        if (
          ...
          onUserAudioStatusChange instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      MeetingAudio_SetUserActiveAudioChangeCB: function (
        onUserActiveAudioChange
      ) {
        if (
          _addon &&
          onUserActiveAudioChange &&
          onUserActiveAudioChange instanceof Function
        ) {
      ...
      */
      MeetingAudio_MuteAudio: function (opts) {
        if (_addon) {
          ...
          try {
            let MuteAudioParams = new pb.MuteAudioParams();
      ...
      */
      MeetingAudio_UnMuteAudio: function (opts) {
        if (_addon) {
          ...
          try {
            let UnmuteAudioParams = new pb.UnmuteAudioParams();
      ...
      */
      MeetingAudio_EnablePlayChimeWhenEnterOrExit: function (opts) {
        if (_addon) {
          ...
          try {
            let EnablePlayChimeWhenEnterOrExitParams =
              new pb.EnablePlayChimeWhenEnterOrExitParams();
