...
export const ZoomMeetingRequestRawLiveStreamPrivilegeHandler = (function () {
  let instance;
  /**
  ...
  function init(opts) {
    ...
    let _addon =
      clientOpts.addon.GetRequestRawLiveStreamPrivilegeHandler() || null;
    ...
    return {
       ...
       * @return {Number} If the function succeeds, the return value is the user ID. Otherwise, this return 0.
       */
