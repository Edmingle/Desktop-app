...
void ZoomNodeMeetingParticipantsCtrlWrap::SetOnAllowParticipantsRequestCloudRecordingCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > cb(isolate, cbfunc);
		ZoomNodeSinkHelper::GetInst().onAllowParticipantsRequestCloudRecording = cb;
...
void ZoomNodeMeetingParticipantsCtrlWrap::GetUserInfoByUserID(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	node->Set(context, v8::String::NewFromUtf8(isolate, "audioVoiceLevel", v8::NewStringType::kInternalized).ToLocalChecked(), v8::Integer::New(isolate, (int32_t)zn_userInfomation.audioVoiceLevel));
