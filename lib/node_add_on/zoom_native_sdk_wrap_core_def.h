...
enum ZNMeetingReminderType
{
	...
	ZNTYPE_SMART_SUMMARY_ENABLE_REQUEST_REMINDER, ///<Reminder type of smart summary enable request.
	ZNTYPE_QUERY_DISCLAIMER, ///<Reminder type of query disclaimer.
	ZNTYPE_QUERY_ENABLE_REQUEST_REMINDER, ///<Reminder type of query enable request.
	ZNTYPE_ENABLE_SMART_SUMMARY_REMINDER, ///<Reminder type of enable smart summary.
	...
	ZNTYPE_SMART_RECORDING_ENABLE_REQUEST_REMINDER,///<Reminder type to enable smart recording request.
	ZNTYPE_ENABLE_SMART_RECORDING_REMINDER,///<Reminder type to enable smart recording.
	ZNTYPE_AI_COMPANION_PLUS_DISCLAIMER, ///<Reminder type of AICompanionPlus disclaimer.
};
...
/*! \struct NormalMeetingChatStaus
    ...
    Here are more detailed structural descriptions..
*/
typedef struct _ZNNormalMeetingChatStaus
{
...
typedef struct _ZNChatStatus
{
	union
	{
		ZNNormalMeetingChatStaus normal_meeting_status;
