...
NODE_MODULE_INIT(/* exports, module, context */) {
	...
	ZoomNodeMeetingReminderCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingChatCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingWaitingRoomCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingSmartSummaryCtrlWrap::Init(exports->GetIsolate());
...
v8::Persistent<v8::Function> ZoomNodeMeetingReminderCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingChatCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingWaitingRoomCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingSmartSummaryCtrlWrap::constructor;
///////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
...
void ZoomNodeAuthWrap::SetLogoutCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onLogout.Clear();
			break;
		}
...
void ZoomNodeAuthWrap::SetOnAuthReturnCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onAuthenticationReturn.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeAuthWrap::SetOnZoomIdentityExpiredCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onZoomIdentityExpired.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeAuthWrap::SetOnZoomAuthIdentityExpiredCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onZoomAuthIdentityExpired.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeAuthWrap::SetLoginReturnWithReasonCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onLoginReturnWithReason.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingWrap::SetMeetingStatusCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onMeetingStatusChanged.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingWrap::SetMeetingStatisticsWarningNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onMeetingStatisticsWarningNotification.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingWrap::SetMeetingParameterNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onMeetingParameterNotification.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingWrap::GetMeetingReminderCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingReminderCtrlWrap::NewInstance(args);
}
void ZoomNodeMeetingWrap::GetMeetingChatCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingChatCtrlWrap::NewInstance(args);
}
void ZoomNodeMeetingWrap::GetMeetingWaitingRoomCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingWaitingRoomCtrlWrap::NewInstance(args);
}
void ZoomNodeMeetingWrap::GetMeetingSmartSummaryCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingSmartSummaryCtrlWrap::NewInstance(args);
}
...
void ZoomNodeMeetingUICtrlWrap::SetInviteButtonClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onInviteBtnClicked.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingUICtrlWrap::SetonStartShareBtnClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onStartShareBtnClicked.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingUICtrlWrap::SetonEndMeetingBtnClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onEndMeetingBtnClicked.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingUICtrlWrap::SetonParticipantListBtnClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onParticipantListBtnClicked.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingUICtrlWrap::SetonCustomLiveStreamMenuClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onCustomLiveStreamMenuClicked.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingUICtrlWrap::SetonZoomInviteDialogFailedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onZoomInviteDialogFailed.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingUICtrlWrap::SetonCCBTNClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onCCBTNClicked.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingUICtrlWrap::SetonAudioBTNClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onAudioBtnClicked.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingUICtrlWrap::SetonAudioMenuBTNClickedCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onAudioMenuBtnClicked.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
