...
void ZoomNodeMeetingConfigCtrlWrap::SetFreeMeetingNeedToUpgradeCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onFreeMeetingNeedToUpgrade.Clear();
			break;
		}
...
void ZoomNodeMeetingConfigCtrlWrap::SetFreeMeetingUpgradeToGiftFreeTrialStartCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onFreeMeetingUpgradeToGiftFreeTrialStart.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingConfigCtrlWrap::SetFreeMeetingUpgradeToGiftFreeTrialStopCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onFreeMeetingUpgradeToGiftFreeTrialStop.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingConfigCtrlWrap::SetFreeMeetingUpgradeToProMeetingCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onFreeMeetingUpgradeToProMeeting.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingConfigCtrlWrap::InputScreenName(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::InputScreenNameParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::InputScreenNameParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		...
		err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().InputScreenName(_zn_screenName);
	} while (false);
	
	v8::Local<v8::Integer> bret = v8::Integer::New(isolate, (int32_t)err);
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingConfigCtrlWrap::CancelJoinWebinar(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingConfigCtrl().CancelJoinWebinar();
	v8::Local<v8::Integer> bret = v8::Integer::New(isolate, (int32_t)err);
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingConfigCtrlWrap::SetInputMeetingPasswordAndScreenNameNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onInputMeetingPasswordAndScreenNameNotification.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingConfigCtrlWrap::SetAirPlayInstructionWndNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onAirPlayInstructionWndNotification.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingConfigCtrlWrap::SetonWebinarNeedRegisterNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onWebinarNeedRegisterNotification.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingConfigCtrlWrap::SetonEndOtherMeetingToJoinMeetingNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onEndOtherMeetingToJoinMeetingNotification.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingConfigCtrlWrap::SetonFreeMeetingRemainTimeCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onFreeMeetingRemainTime.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingConfigCtrlWrap::SetonFreeMeetingRemainTimeStopCountDownCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onFreeMeetingRemainTimeStopCountDown.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
...
void ZoomNodeMeetingConfigCtrlWrap::SetonWebinarNeedInputScreenNameCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onWebinarNeedInputScreenName.Clear();
			break;
		}
		if (!args[0]->IsFunction())
		{
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > cb(isolate, cbfunc);
		ZoomNodeSinkHelper::GetInst().onWebinarNeedInputScreenName = cb;
