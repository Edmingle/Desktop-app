...
ZNSDKError ZMeetingConfigWrap::InputScreenName(ZoomSTRING screenName)
{
	return ZWebinarInputScreenNameHandler::GetInst().InputName(screenName);
}
ZNSDKError ZMeetingConfigWrap::CancelJoinWebinar()
{
	return ZWebinarInputScreenNameHandler::GetInst().Cancel();
}
