...
#include "meeting_service_components_wrap/meeting_smart_summary_wrap.cpp"
//
...
#include "meeting_service_components_wrap/meeting_reminder_ctrl_wrap.cpp"
...
ZNSDKError ZNativeSDKWrap::InitSDK(ZNInitParam& initParam)
{
	...
	param.wrapperType = initParam.wrapperType;
