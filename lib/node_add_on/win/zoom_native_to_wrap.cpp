...
ZNMeetingReminderType Map2WrapDefine(ZOOM_SDK_NAMESPACE::MeetingReminderType type)
{
	...
	case ZOOMSDK::TYPE_SMART_SUMMARY_DISCLAIMER:
		...
		break;
	case ZOOMSDK::TYPE_SMART_SUMMARY_ENABLE_REQUEST_REMINDER:
		zn_reminder_type = ZNTYPE_SMART_SUMMARY_ENABLE_REQUEST_REMINDER;
		break;
	case ZOOMSDK::TYPE_QUERY_DISCLAIMER:
		zn_reminder_type = ZNTYPE_QUERY_DISCLAIMER;
		break;
	case ZOOMSDK::TYPE_QUERY_ENABLE_REQUEST_REMINDER:
		zn_reminder_type = ZNTYPE_QUERY_ENABLE_REQUEST_REMINDER;
		break;
	case ZOOMSDK::TYPE_ENABLE_SMART_SUMMARY_REMINDER:
		zn_reminder_type = ZNTYPE_ENABLE_SMART_SUMMARY_REMINDER;
		break;
	...
	case ZOOMSDK::TYPE_JOIN_PRIVATE_MODE_MEETING_REMINDER:
		...
		break;
	case ZOOMSDK::TYPE_SMART_RECORDING_ENABLE_REQUEST_REMINDER:
		zn_reminder_type = ZNTYPE_SMART_RECORDING_ENABLE_REQUEST_REMINDER;
		break;
	case ZOOMSDK::TYPE_ENABLE_SMART_RECORDING_REMINDER:
		zn_reminder_type = ZNTYPE_ENABLE_SMART_RECORDING_REMINDER;
		break;
	case ZOOMSDK::TYPE_AI_COMPANION_PLUS_DISCLAIMER:
		zn_reminder_type = ZNTYPE_AI_COMPANION_PLUS_DISCLAIMER;
		break;
	default:
		break;
	}
