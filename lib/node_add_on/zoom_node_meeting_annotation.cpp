...
void ZoomNodeMeetingAnnotationWrap::IsAnnotationDisable(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	bool bDisable = _g_native_wrap.GetMeetingServiceWrap().GetMeetingAnnotation().IsAnnotationDisable();
