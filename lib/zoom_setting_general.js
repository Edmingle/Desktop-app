...
export const ZoomGeneralSetting = (function () {
  var instance;
  /**
    ...
    return {
      ...
      Setting_EnableDualScreenMode: function (opts) {
        if (_addon) {
          ...
          try {
            let EnableDualScreenModeParams = new pb.EnableDualScreenModeParams();
      ...
      */
      Setting_TurnOffAeroModeInSharing: function (opts) {
        if (_addon) {
          ...
          let zn_bEnable = clientOpts.zn_bEnable;
          try {
            let TurnOffAeroModeInSharingParams =
              new pb.TurnOffAeroModeInSharingParams();
      ...
      */
      Setting_EnableAutoFullScreenVideoWhenJoinMeeting: function (opts) {
        if (_addon) {
          ...
          let zn_bEnable = clientOpts.zn_bEnable;
          try {
            let EnableAutoFullScreenVideoWhenJoinMeetingParams =
              new pb.EnableAutoFullScreenVideoWhenJoinMeetingParams();
            EnableAutoFullScreenVideoWhenJoinMeetingParams.setBenable(
              zn_bEnable
            );
            let bytes =
              EnableAutoFullScreenVideoWhenJoinMeetingParams.serializeBinary();
      ...
      */
      Setting_EnableSplitScreenMode: function (opts) {
        if (_addon) {
          ...
          let zn_bEnable = clientOpts.zn_bEnable;
          try {
            let EnableSplitScreenModeParams =
              new pb.EnableSplitScreenModeParams();
      ...
      */
      Setting_EnableDisplayReminderWindowWhenExit: function (opts) {
        if (_addon) {
          ...
          try {
            let EnableDisplayReminderWindowWhenExitParams =
              new pb.EnableDisplayReminderWindowWhenExitParams();
            EnableDisplayReminderWindowWhenExitParams.setBenable(bEnable);
            let bytes =
              EnableDisplayReminderWindowWhenExitParams.serializeBinary();
      ...
      */
      Setting_EnableShowMyMeetingElapseTime: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableShowMyMeetingElapseTimeParams =
              new pb.EnableShowMyMeetingElapseTimeParams();
