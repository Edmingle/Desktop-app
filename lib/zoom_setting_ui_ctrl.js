...
export const ZoomSettingUICtrl = (function () {
  var instance;
  /**
    ...
    return {
      ...
      SettingUI_DisableAdvancedFeatures4GeneralSetting: function (opts) {
        if (_addon) {
          ...
          try {
            let DisableAdvancedFeatures4GeneralSettingParams =
              new pb.DisableAdvancedFeatures4GeneralSettingParams();
            DisableAdvancedFeatures4GeneralSettingParams.setBdisable(bDisable);
            let bytes =
              DisableAdvancedFeatures4GeneralSettingParams.serializeBinary();
      ...
      SettingUI_DisableAccountSettingTabPage: function (opts) {
        if (_addon) {
          ...
          let bDisable = clientOpts.bDisable;
          try {
            let DisableAccountSettingTabPageParams =
              new pb.DisableAccountSettingTabPageParams();
      ...
      */
      SettingUI_ConfSettingDialogShownTabPage: function (opts) {
        if (_addon) {
          ...
          try {
            let ConfSettingDialogShownTabPageParams =
              new pb.ConfSettingDialogShownTabPageParams();
      ...
      SettingUI_HideAutoCopyInviteLinkCheckBox: function (opts) {
        if (_addon) {
          ...
          try {
            let HideAutoCopyInviteLinkCheckBoxParams =
              new pb.HideAutoCopyInviteLinkCheckBoxParams();
      ...
      */
      SettingUI_ConfigToShowUrlLinksInSetting: function (opts) {
        if (_addon) {
          ...
          try {
            let ConfigToShowUrlLinksInSettingParams =
              new pb.ConfigToShowUrlLinksInSettingParams();
