...
export const ZoomAudioSetting = (function () {
  let instance;
  /**
   * Zoom Audio Setting
  ...
  function init(opts) {
    ...
    let _onComputerMicDeviceChanged =
      clientOpts.onComputerMicDeviceChanged || null;
    let _onComputerSpeakerDeviceChanged =
      clientOpts.onComputerSpeakerDeviceChanged || null;
    let _onDefaultMicDeviceChanged =
      clientOpts.onDefaultMicDeviceChanged || null;
    let _onDefaultSpeakerDeviceChanged =
      clientOpts.onDefaultSpeakerDeviceChanged || null;
    ...
    */
    ...
    return {
       ...
       * @return {Boolean}
       */
      Setting_SetComputerMicDeviceChangedCB: function (
        onComputerMicDeviceChanged,
      ) {
        if (
          _addon &&
          onComputerMicDeviceChanged &&
          onComputerMicDeviceChanged instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      Setting_SetComputerSpeakerDeviceChangedCB: function (
        onComputerSpeakerDeviceChanged,
      ) {
        if (
          _addon &&
          onComputerSpeakerDeviceChanged &&
          onComputerSpeakerDeviceChanged instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      Setting_SetDefaultMicDeviceChangedCB: function (
        onDefaultMicDeviceChanged,
      ) {
        if (
          _addon &&
          onDefaultMicDeviceChanged &&
          onDefaultMicDeviceChanged instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      Setting_SetDefaultSpeakerDeviceChangedCB: function (
        onDefaultSpeakerDeviceChanged,
      ) {
        if (
          _addon &&
          onDefaultSpeakerDeviceChanged &&
          onDefaultSpeakerDeviceChanged instanceof Function
        ) {
      ...
      Setting_SelectMic: function (opts) {
        if (_addon) {
          ...
          try {
            let SelectMicParams = new pb.SelectMicParams();
      ...
      */
      Setting_SelectSpeaker: function (opts) {
        if (_addon) {
          ...
          try {
            let SelectSpeakerParams = new pb.SelectSpeakerParams();
      ...
      */
      Setting_EnableAutoJoinAudio: function (opts) {
        if (_addon) {
          ...
          try {
            let EnableAutoJoinAudioParams = new pb.EnableAutoJoinAudioParams();
      ...
      */
      Setting_EnableAutoAdjustMic: function (opts) {
        if (_addon) {
          ...
          let zn_bEnable = clientOpts.zn_bEnable;
          try {
            let EnableAutoAdjustMicParams = new pb.EnableAutoAdjustMicParams();
      ...
      */
      Setting_EnableStereoAudio: function (opts) {
        if (_addon) {
          ...
          try {
            let EnableStereoAudioParams = new pb.EnableStereoAudioParams();
      ...
      */
      Setting_EnableMicOriginalInput: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableMicOriginalInputParams =
              new pb.EnableMicOriginalInputParams();
      ...
      */
      Setting_EnableHoldSpaceKeyToSpeak: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableHoldSpaceKeyToSpeakParams =
              new pb.EnableHoldSpaceKeyToSpeakParams();
      ...
      */
      Setting_EnableAlwaysMuteMicWhenJoinVoip: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableAlwaysMuteMicWhenJoinVoipParams =
              new pb.EnableAlwaysMuteMicWhenJoinVoipParams();
      ...
      */
      Setting_EnableSuppressAudioNotify: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableSuppressAudioNotifyParams =
              new pb.EnableSuppressAudioNotifyParams();
      ...
      */
      Setting_SetEchoCancellationLevel: function (opts) {
        if (_addon) {
          ...
          try {
            let SetEchoCancellationLevelParams =
              new pb.SetEchoCancellationLevelParams();
      ...
      Setting_SetMicVol: function (opts) {
        if (_addon) {
          ...
          try {
            let SetMicVolParams = new pb.SetMicVolParams();
      ...
      Setting_SetSpeakerVol: function (opts) {
        if (_addon) {
          ...
          let value = clientOpts.value;
          try {
            let SetSpeakerVolParams = new pb.SetSpeakerVolParams();
