...
export const ZoomVideoSetting = (function () {
  let instance;
  /**
   * Zoom Video Setting
  ...
  function init(opts) {
    ...
    let _onComputerCamDeviceChanged =
      clientOpts.onComputerCamDeviceChanged || null;
    let _onDefaultCamDeviceChanged =
      clientOpts.onDefaultCamDeviceChanged || null;
    ...
    */
    ...
    return {
       ...
       * @return {Boolean}
       */
      Setting_SetComputerCamDeviceChangedCB: function (
        onComputerCamDeviceChanged
      ) {
        if (
          _addon &&
          onComputerCamDeviceChanged &&
          onComputerCamDeviceChanged instanceof Function
        ) {
       ...
       * @return {Boolean}
       */
      Setting_SetDefaultCamDeviceChangedCB: function (
        onDefaultCamDeviceChanged
      ) {
        if (
          _addon &&
          onDefaultCamDeviceChanged &&
          onDefaultCamDeviceChanged instanceof Function
        ) {
      ...
      */
      Setting_SelectVideoCamera: function (opts) {
        if (_addon) {
          ...
          try {
            let SelectVideoCameraParams = new pb.SelectVideoCameraParams();
      ...
      */
      Setting_EnableVideoMirrorEffect: function (opts) {
        if (_addon) {
          ...
          try {
            let EnableVideoMirrorEffectParams =
              new pb.EnableVideoMirrorEffectParams();
      ...
      */
      Setting_EnableFaceBeautyEffect: function (opts) {
        if (_addon) {
          ...
          let zn_bEnable = clientOpts.zn_bEnable;
          try {
            let EnableFaceBeautyEffectParams =
              new pb.EnableFaceBeautyEffectParams();
      ...
      */
      Setting_EnableHDVideo: function (opts) {
        if (_addon) {
          ...
          try {
            let EnableHDVideoParams = new pb.EnableHDVideoParams();
      ...
      */
      Setting_EnableAlwaysShowNameOnVideo: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableAlwaysShowNameOnVideoParams =
              new pb.EnableAlwaysShowNameOnVideoParams();
      ...
      */
      Setting_EnableAutoTurnOffVideoWhenJoinMeeting: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableAutoTurnOffVideoWhenJoinMeetingParams =
              new pb.EnableAutoTurnOffVideoWhenJoinMeetingParams();
            EnableAutoTurnOffVideoWhenJoinMeetingParams.setBenable(bEnable);
            let bytes =
              EnableAutoTurnOffVideoWhenJoinMeetingParams.serializeBinary();
      ...
      */
      Setting_EnableSpotlightSelf: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableSpotlightSelfParams = new pb.EnableSpotlightSelfParams();
      ...
      */
      Setting_EnableHardwareEncode: function (opts) {
        if (_addon) {
          ...
          try {
            let EnableHardwareEncodeParams = new pb.EnableHardwareEncodeParams();
      ...
      Setting_IsHardwareEncodeEnabled: function () {
        if (_addon) {
          ...
          let encodeType = clientOpts.encodeType;
          try {
            let IsHardwareEncodeEnabledParams =
              new pb.IsHardwareEncodeEnabledParams();
      ...
      */
      Setting_Enable49VideoesInGallaryView: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let Enable49VideoesInGallaryViewParams =
              new pb.Enable49VideoesInGallaryViewParams();
      ...
      */
      Setting_EnableHideNoVideoUsersOnWallView: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableHideNoVideoUsersOnWallViewParams =
              new pb.EnableHideNoVideoUsersOnWallViewParams();
            EnableHideNoVideoUsersOnWallViewParams.setBenable(bEnable);
            let bytes =
              EnableHideNoVideoUsersOnWallViewParams.serializeBinary();
      ...
      */
      Setting_EnableVideoPreviewDialog: function (opts) {
        if (_addon) {
          ...
          let bEnable = clientOpts.bEnable;
          try {
            let EnableVideoPreviewDialogParams =
              new pb.EnableVideoPreviewDialogParams();
